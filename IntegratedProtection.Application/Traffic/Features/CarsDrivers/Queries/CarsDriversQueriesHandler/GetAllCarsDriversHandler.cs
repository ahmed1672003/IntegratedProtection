using IntegratedProtection.Application.Traffic.Features.CarsDrivers.Queries.CarsDriversQueries;

namespace IntegratedProtection.Application.Traffic.Features.CarsDrivers.Queries.CarsDriversQueriesHandler;
